...
impl HealthSnapshot {
    ...
    pub fn prometheus_text(&self) -> String {
        ...
        out.push_str("# HELP brainstem_live 1 if the process health reporter is running.\n");
        out.push_str("# TYPE brainstem_live gauge\n");
        out.push_str(&format!("brainstem_live {}\n", u8::from(self.live)));

        out.push_str(
            "# HELP brainstem_ready 1 if initialized, checkpoint-valid, not draining, not fatal.\n",
        );
        ...
        out.push_str(
            "# HELP brainstem_fatal 1 if this process has entered a sticky fatal state.\n",
        );
        ...
        out.push_str(
            "# HELP brainstem_last_successful_tick_ms Milliseconds since start of last successful tick.\n",
        );
        ...
        out.push_str("# HELP brainstem_input_age_ms Age of last ingress sample in milliseconds.\n");
        ...
        out.push_str("# HELP brainstem_queue_depth Ingress queue depth.\n");
        ...
        out.push_str("# HELP brainstem_queue_capacity Ingress queue capacity.\n");
    ...
    pub fn apply(&mut self, event: HealthEvent) {
        ...
        match event {
            ...
            HealthEvent::InitializationCompleted => {
                if self.fatal.is_some() || self.draining {
                    return;
                }
